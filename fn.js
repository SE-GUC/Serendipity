...
updateWorkshop: async (id, req) => {
  try {
   // const path = "http://localhost:3000/api/courses/" + id;
    ...
    const workshop = await axios.get("http://localhost:3000/api/workshops/"+id);
  return workshop
    //return 
  } catch (err) {
    return "error";
...
applyForWorkshop: async(cid,mid) =>{
    const path = 'http://localhost:3000/api/workshops/'+cid+'/apply'
    return await axios.put(path,{"applicantId" : "\""+mid+"\" "} )
},
getWorkshop: async () => {
    const workshop= await axios.get('http://localhost:3000/api/workshops/')
    return workshop
},
...
deleteWorkshop: async (id) => {
  ...
  getEduOrg: async () => {
    const educationalOrganizations = await axios.get(
      "http://localhost:3000/api/educationalOrganizations/"
    );
  ...
  getEduOrgById: async id => {
    const educationalOrganizations = await axios.get(
      "http://localhost:3000/api/educationalOrganizations/" + id
    );
    return educationalOrganizations;
  },
  ...
  createEduOrg: async data => {
    await axios
      .post("http://localhost:3000/api/educationalOrganizations/", data)
      .then(res => res.data)
      .catch(e => "error");
  },
  //4.delete
  deleteEduOrg: async id => {
    await axios
      .delete("http://localhost:3000/api/educationalOrganizations/" + id)
      .then(res => res.data)
      .catch(e => "error");
  },
  //5.update
  updateEduOrg: async (id, data) => {
    await axios
      .put("http://localhost:3000/api/educationalOrganizations/" + id, data)
      .then(res => res.data)
      .catch(e => "error");
  },
  // ////////////////Partners
  ...
  getPartners: async () => {
    const partners = await axios.get("http://localhost:3000/api/partners/");
    return partners;
  },
  getPartner: async id => {
    const partner = await axios.get("http://localhost:3000/api/partners/" + id);
    return partner;
  },
  createPartner: async data => {
    await axios
      .post("http://localhost:3000/api/partners/", data)
      .then(res => res.data)
      .catch(e => "error");
  ...
  updatePartner: async (id, data) => {
    await axios
      .put("http://localhost:3000/api/partners/" + id, data)
      .then(res => res.data)
      .catch(e => "error");
  },
  ...
  createMaster: async data => {
    return await axios.post(`http://localhost:3000/api/masterclasses/`, data);
  },
  readMaster: async id => {
    return await axios.get(`http://localhost:3000/api/masterclasses/${id}`);
  },
  deleteMaster: async id => {
    return await axios.delete(`http://localhost:3000/api/masterclasses/${id}`);
  },
  updateMaster: async (id, data) => {
    return await axios.put(`http://localhost:3000/api/masterclasses/${id}`, data);
  },

  getmasters: async () => {
    const masters = await axios.get("http://localhost:3000/api/masterclasses/");
    return masters;
  },
  createMasterM: async data => {
   await  axios
      .post("http://localhost:3000/api/masterclasses/", data)
      .then(res => res.data)
      .catch(e => "error");
  },
  updateMasterM: async (id, data) => {
    // axios
    //   .put("http://localhost:3000/api/masterclasses/${id}", data)
    //   .then(res => res.data)
    //   .catch(e => "error");
  ...
  deleteMasterM: async id => {
    await axios
      .delete("http://localhost:3000/api/masterclasses/" + id)
      .then(res => res.data)
      .catch(e => "error");
  },
  getMasterM: async id => {
    const partner = await axios.get(
      "http://localhost:3000/api/masterclasses/" + id
    );
    return partner;
  },
  ...
  updateAdmin: async (id, data) => {
    //console.log("10")
    await axios
      .put("http://localhost:3000/api/admins/" + id, data)
      .then(res => res.data)
      .catch(e => "error");
    //console.log("11")
  },
